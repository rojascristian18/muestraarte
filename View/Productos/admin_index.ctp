				...
				<table class="table">
					<thead>
						<tr class="sort">
							...
							<th><?= $this->Paginator->sort('sku', null, array('title' => 'Haz click para ordenar por este criterio')); ?></th>
							...
							<th><?= $this->Paginator->sort('descripcion_corta', null, array('title' => 'Haz click para ordenar por este criterio')); ?></th>
							<th>Acciones</th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							<td><?= $this->Html->link($producto['Tienda']['id'], array('controller' => 'tiendas', 'action' => 'edit', $producto['Tienda']['id'])); ?></td>
							<td><?= h($producto['Producto']['sku']); ?>&nbsp;</td>
							<td><?= h($producto['Producto']['titulo']); ?>&nbsp;</td>
							<td><?= h($producto['Producto']['slug']); ?>&nbsp;</td>
							<td><?= h($producto['Producto']['descripcion_corta']); ?>&nbsp;</td>
							<td>
